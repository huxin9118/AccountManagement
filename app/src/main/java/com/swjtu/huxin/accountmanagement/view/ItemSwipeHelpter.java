 ...
 */
public class ItemSwipeHelpter implements RecyclerView.OnItemTouchListener,GestureDetector.OnGestureListener {
    /**
     * 动画执行的时间
     */
    ...
    private ItemSwipeLayout mSwipeLayout;

    public ItemSwipeHelpter(Context context, Callback callback) {
        mContext = context;
        mCallback = callback;
...
//                        needIntercept = false; //这里可以直接做结束动画
    ...
    public  interface Callback {
         ItemSwipeLayout getSwipLayout(float x, float y);
    }
