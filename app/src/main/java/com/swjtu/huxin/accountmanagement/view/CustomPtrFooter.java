...
public class CustomPtrFooter extends FrameLayout implements PtrUIHandler {
    ...
    private String loadMoreFinish = "加载完成";
    ...
    public CustomPtrFooter(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews(attrs);
    }

    public CustomPtrFooter(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        buildAnimation();
        View header = LayoutInflater.from(getContext()).inflate(in.srain.cube.views.ptr.R.layout.cube_ptr_classic_default_footer, this);
    ...
    public void setLoadMoreFinish(String loadMoreFinish) {
        this.loadMoreFinish = loadMoreFinish;
    }
    ...
    public void onUIRefreshComplete(PtrFrameLayout frame, boolean isHeader) {
        ...
        mTitleTextView.setVisibility(VISIBLE);
        mTitleTextView.setText(loadMoreFinish);
